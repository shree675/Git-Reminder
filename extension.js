...
async function perform(context) {
      ...
      vscode.window
        ...
        .then(async (e) => {
          try {
            if (e !== undefined) {
              vscode.window
                .showInputBox({ prompt: "Type in your commit message" })
                .then(async (message) => {
            ...
            vscode.window
              ...
              .then(async (message) => {
                if (message === undefined) {
                  ...
                  vscode.window
                    .showInformationMessage(
                      "Would you like to push your commits?",
                      "Git Push"
                    )
                    .then(async (option) => {
                      if (option !== undefined) {
  ...
  vscode.window
    .showInformationMessage(
      "Keep your work up to date. Do not forget to pull before you start!",
      "Git Pull"
    )
    .then(async (e) => {
      if (e !== undefined) {
        ...
        if (chosenBranch !== undefined) {
          try {
            await git
              ...
              .then(async () => {
                var showMessage =
                  "Pulled changes from " + chosenBranch + " successfully";
